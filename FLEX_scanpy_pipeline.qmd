...
pilot_pool = "snapfrozen_unsorted_1stpilot"
mask_001 = (
    (flex_adata.obs['pool_id'] == pilot_pool) &
    (flex_adata.obs['donor'] == 'BC001')
)
mask_003 = (
    (flex_adata.obs['pool_id'] == pilot_pool) &
    (flex_adata.obs['donor'] == 'BC003')
)
flex_adata.obs.loc[mask_001, 'donor'] = 'BC005'
flex_adata.obs.loc[mask_003, 'donor'] = 'BC006'
...
immune_genes = ["PTPRC", "CD3D", "CD4", "CD8A", "NKG7", "GZMB", "LYZ", "CD14", "FCGR3A", "CD68", "CD1C", "CD79A"]
