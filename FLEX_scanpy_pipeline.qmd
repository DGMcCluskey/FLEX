...
sc.pl.umap(flex_adata, color=["celltypist_label_foetal_lung_celltypist"])
plt.tight_layout()
plt.savefig("UMAP_scvi_celltypist.png",dpi=300)
```

```{python}
sc.pl.umap(flex_adata, color=["CD3D", "LYZ", "CD79A"])
```
