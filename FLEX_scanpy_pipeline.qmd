...
counts = (
    flex_adata.obs
    .groupby(["gestation_bin", "celltypist_label_foetal_lung_celltypist"])
    .size()
    .unstack(fill_value=0)
)
...
plt.tight_layout()
plt.savefig("Celltypist_proportions_by_gestation_bin.png", dpi=300, bbox_inches="tight")
plt.show()
```
